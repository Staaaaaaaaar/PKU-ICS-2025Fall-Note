...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe.png}
\end{figure}

\subsubsection{PC 选择和取指阶段}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-PC-select-fetch.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-decode-write-back.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/forwarding.png}
\end{figure}
\begin{lstlisting}[style=CStyle]
word d_valA = [
...
上述 HCL 代码中赋予这 5 个转发源的优先级是非常重要的。如果选择了其他任何顺序，对某些程序来说，流水线就会出错。
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-execute.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-memory.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/normal-stall-bubble.png}
\end{figure}

假设每个流水线寄存器有两个控制输入：暂停 (stall) 和气泡 (bubble)。这些信号的设
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-control.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-control-detection.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-control-action.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/pipe-control-combination.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/combination-A.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{processor/combination-B.png}
\end{figure}
