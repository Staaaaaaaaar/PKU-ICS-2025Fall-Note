...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{machine/stack-structure.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{machine/memory-layout.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{machine/code-injection-attacks.png}
\end{figure}
